...
wmut1 = squeeze((1/N)*info_MUT(1,2,:,l));
wmut2 = squeeze((1/N)*info_MUT(1,3,:,l));
wmut3 = squeeze((1/N)*info_MUT(1,4,:,l));


rmut1 = squeeze((1/N)*info_MUT(2,2,:,l));
rmut2 = squeeze((1/N)*info_MUT(2,3,:,l));
rmut3 = squeeze((1/N)*info_MUT(2,4,:,l));
